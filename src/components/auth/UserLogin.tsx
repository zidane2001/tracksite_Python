      ...
      <div className="max-w-md w-full space-y-8 relative z-10">
        ...
        <div className="text-center">
          <div className="avatar mb-6">
            <div className="w-20 rounded-2xl bg-gradient-to-br from-primary to-primary-focus">
              <svg className="h-10 w-10 text-primary-content" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-10">
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body text-center">
              ...
              <h3 className="card-title justify-center text-sm">Suivi en temps réel</h3>
              <p className="text-xs text-base-content/60">Suivez vos colis 24/7</p>
            </div>
          </div>
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body text-center">
              ...
              <h3 className="card-title justify-center text-sm">Sécurisé</h3>
              <p className="text-xs text-base-content/60">Protection des données</p>
            </div>
          </div>
          <div className="card bg-base-100 shadow-lg">
            <div className="card-body text-center">
              ...
              <h3 className="card-title justify-center text-sm">Rapide</h3>
              <p className="text-xs text-base-content/60">Livraison express</p>
            </div>
          </div>
        </div>
      </div>
